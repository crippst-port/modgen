...
$string['maxquicksections_desc'] = 'Maximum number of themes or weeks that can be created at once using the quick-add forms. This limit applies to both theme and week creation. Default: 30';
